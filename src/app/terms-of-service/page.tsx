              ...
              <div className="space-y-8 text-gray-700 dark:text-gray-300">
                <section>
                  ...
                  <p className="leading-relaxed">
                    By accessing or using Pushup (&apos;the Service&apos;), you
                ...
                <section>
                  ...
                  <p className="leading-relaxed">
                    Pushup provides a whole different habit tracking systems which keeps the user very accountable which also includes a a ranking based on how consistent the user is. Our Service will ask the user to create a set of habits which the user later have to notify on the progress is it done,doing, or will do it later. Using all this information we will create a global rank for the user, which will show where the user stands and how much more he can level up. These all features are provided to help the user stay consistent and motivated.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-3">
                    <p className="leading-relaxed">
                      We don&apos;t charge anything for this app, its completely free to use for everyone.
                      But in future we might promote some premium features which will be paid.
                    </p>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="leading-relaxed">
                      ...
                      functionality are owned by Pushup and are protected by
                ...
                <section>
                  ...
                  <p className="leading-relaxed uppercase font-medium">
                    To the maximum extent permitted by law, Pushup shall not
                ...
                <section>
                  ...
                  <p className="leading-relaxed">
                    You agree to defend, indemnify, and hold harmless Pushup
                ...
                <section className="pt-8 border-t border-gray-200 dark:border-gray-700">
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    By using Pushup, you acknowledge that you have read,
